...
public class TestShapes extends SimpleApplication{
    ...
    public void simpleInitApp(){
        ...
        BlockTerrainControlNew1 blockTerrain = new BlockTerrainControlNew1(CubesTestAssets.getSettings(this), null);
        ...
        blockTerrain.setBlock(new Vector3Int(0, 0, 1), CubesTestAssets.BLOCK_WATER);
